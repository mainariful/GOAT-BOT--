...
let pathLanguageFile = `${__dirname}/${global.Anchestor.config.language}.lang`;
if (!fs.existsSync(pathLanguageFile)) {
	log.warn("LANGUAGE", `Can't find language file ${global.Anchestor.config.language}.lang, using default language file "${__dirname}/en.lang"`);
